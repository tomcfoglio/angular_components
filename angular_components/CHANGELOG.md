...
* Add `selectDatePlaceHolderMsg` and `placeholderMsg` inputs.
...
* Improve aria rols for `MenuItemGroup` items.
...
* Ensure footer stays inside popup boundries.
...
* Add Sass mixins to customize the background color of the selected item na
...
* Add `isActive` input to focus trap.
